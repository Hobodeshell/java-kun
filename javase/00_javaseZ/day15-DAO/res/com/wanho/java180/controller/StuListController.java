...
public class StuListController implements Initializable {
    ...
    @FXML
    private RadioButton ageAscRadio ;
    @FXML
    private RadioButton ageDescRadio ;
    @FXML
    private TextField snameTxf;
    @FXML
    private TextField addressTxf;
    @FXML
    private TextField minAgeTxf;
    @FXML
    private TextField maxAgeTxf;
    @FXML
    ...
    public void search() {
        ...
        String maxAge = maxAgeTxf.getText();
        String minAge = minAgeTxf.getText();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        //把按钮放在按钮组中
        ageAscRadio.setToggleGroup(group);
        ageDescRadio.setToggleGroup(group);
