...
public class CustomerController {
     ...
     * 界面视图 观察者模式：
     */
    private ObservableList<String> datList = FXCollections.observableArrayList();
     ...
     * @param customerAy
     */
    private void fillData2ListView(String[] customerAy) {
        //先清空  界面中数据
        datList.clear();
        //循环数组 存放数据到观察者集合中
        for (int i = 0; i < customerAy.length; i++) {
            datList.add(customerAy[i]) ;
        }
        //绑定数据到view中
        dataListView.setItems(datList);
    }
}
