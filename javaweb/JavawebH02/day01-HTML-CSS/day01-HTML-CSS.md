...
- HTML：负责网页的结构（页面元素和内容）。（只有html会比较凌乱）

- CSS：负责网页的表现（页面元素的外观、位置等页面样式，如：颜色、大小等）。（就是化妆）
...
![image-20230605094829234](E:\500-归档\Java\javaweb\JavawebH\day01-HTML-CSS\assets\image-20230605094829234.png)
...
>
> - 标记语言：由标签构成的语言（xml是可扩展的标签语言）
>   - HTML标签都是**预定义好的**。例如：使用 <h1> 标签展示标题，使用<a>展示超链接，使用<img>展示图片，<video>展示视频。
...
&lt;head&gt;和&lt;body&gt;是子标签，&lt;head&gt;中的字标签&lt;title&gt;是用来定义网页的标题的，里面定义的内容会显示在浏览器网页的标题位置。
...
| 十六进制表示法 | #开头，将数字转换成十六进制表示   | #000000、#ff0000、#cccccc，简写：#000、#f00、#ccc |
