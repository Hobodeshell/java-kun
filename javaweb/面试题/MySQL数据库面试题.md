...
[![img](http://118.25.100.99/img/img_mysql/90.png?imageView2/2/w/1280/format/jpg/interlace/1/q/100)](javascript:void(0))
...
[![img](http://118.25.100.99/img/img_mysql/91.png?imageView2/2/w/1280/format/jpg/interlace/1/q/100)](javascript:void(0))
...
[![img](http://118.25.100.99/img/img_mysql/92.png?imageView2/2/w/1280/format/jpg/interlace/1/q/100)](javascript:void(0))
...
[![img](http://118.25.100.99/img/img_mysql/93.png?imageView2/2/w/1280/format/jpg/interlace/1/q/100)](javascript:void(0))
...
[![img](http://118.25.100.99/img/img_mysql/105.png?imageView2/2/w/1280/format/jpg/interlace/1/q/100)](javascript:void(0))
...
- B+树的叶子节点有一条链相连，而B树的叶子节点各自独立。
  ...
  [![img](http://118.25.100.99/img/img_mysql/94.png?imageView2/2/w/1280/format/jpg/interlace/1/q/100)](javascript:void(0))
...
[![img](http://118.25.100.99/img/img_mysql/104.png?imageView2/2/w/1280/format/jpg/interlace/1/q/100)](javascript:void(0))
...
[![事务的特性](http://118.25.100.99/img/img_mysql/95.png?imageView2/2/w/1280/format/jpg/interlace/1/q/100)](javascript:void(0))

[事务的特性](javascript:void(0))
...
[![在这里插入图片描述](http://118.25.100.99/img/img_mysql/96.png?imageView2/2/w/1280/format/jpg/interlace/1/q/100)](javascript:void(0))
...
6. 关掉连接，释放资源
   ...
   [![在这里插入图片描述](http://118.25.100.99/img/img_mysql/97.png?imageView2/2/w/1280/format/jpg/interlace/1/q/100)](javascript:void(0))
...
1. **垂直分区：**
   ...
   **简单来说垂直拆分是指数据表列的拆分，把一张列比较多的表拆分为多张表。** 如下图所示，这样来说大家应该就更容易理解了。
   ...
   [![img](http://118.25.100.99/img/img_mysql/98.png?imageView2/2/w/1280/format/jpg/interlace/1/q/100)](javascript:void(0))
   ...
   **垂直拆分的缺点：** 主键会出现冗余，需要管理冗余列，并会引起Join操作，可以通过在应用层进行Join来解决。此外，垂直分区会让事务变得更加复杂；
   ...
   [![img](http://118.25.100.99/img/img_mysql/99.png?imageView2/2/w/1280/format/jpg/interlace/1/q/100)](javascript:void(0))
...
2. **水平分区：**
   ...
   **保持数据表结构不变，通过某种策略存储数据分片。这样每一片数据分散到不同的表或者库中，达到了分布式的目的。 水平拆分可以支撑非常大的数据量。**
   ...
   [![数据库水平拆分](http://118.25.100.99/img/img_mysql/100.png?imageView2/2/w/1280/format/jpg/interlace/1/q/100)](javascript:void(0))

   [数据库水平拆分](javascript:void(0))
   ...
   [![img](http://118.25.100.99/img/img_mysql/101.png?imageView2/2/w/1280/format/jpg/interlace/1/q/100)](javascript:void(0))
...
- 跨分片的排序分页
  ...
  [![在这里插入图片描述](http://118.25.100.99/img/img_mysql/102.png?imageView2/2/w/1280/format/jpg/interlace/1/q/100)](javascript:void(0))
...
[![img](http://118.25.100.99/img/img_mysql/103.png?imageView2/2/w/1280/format/jpg/interlace/1/q/100)](javascript:void(0))
