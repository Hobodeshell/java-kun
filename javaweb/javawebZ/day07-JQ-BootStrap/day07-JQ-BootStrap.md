...
![image-20210806085831519](images\jq.png)
...
根据所给res素材  ： 01-导航隐藏显示.html 

实现： 鼠标进入/离开 实现显示与隐藏

![image-20210806085831519](images\ex-hover.png)
...
使用所给 素材： 02-tab栏切换.html     使用 hover事件 实现切换tab效果

![image-20210806085831519](images\ex2-hover.png)
...
![image-20210806085831519](images\add-comment.png)

![image-20210806085831519](images\del-comment.png)
...
![image-20210806085831519](images\table.png)
...
<html lang="en">
  <head>
    ...
    />
    <script src="./bootstrap-3.4.1-dist/js/jquery-3.6.0.js"></script>
      ...
      <table class="table table-striped table-bordered table-hover">
        ...
        <tbody>
          <tr>
            ...
            <td>男</td>
            <td>
              <a href="./modify-stu.jsp" class="btn btn-info btn-sm">修改</a>
...
![image-20210806085831519](images\form.png)
...
<html lang="en">
  ...
  <body>
    <div class="container" style="width: 400px">
      <h1>新增学生</h1>
      <form action="./add-stu-do.jsp" method="post">
...
![image-20210806085831519](images\page.png)
  ...
  <body>
    <div class="container">
      ...
      <div style="float: left; padding-bottom: 20px">
        <form class="form-inline" action="./list-stu.jsp">
          <div class="form-group">
            <label for="sid">学号</label>
            <input
              type="text"
      ...
      <div class="ope" style="float: right">
        <a href="./02-新增学生.html" class="btn btn-primary">添加学生</a>
        <a href="" class="btn btn-danger">删除选中</a>
      </div>
